...
return[
    ...
    'CALLBACK_SIGNIN_SIGNUP_SUCCESS' => env('APP_URL'). ':8000/login/account/signin',
    'CALLBACK_SIGNIN_SIGNUP_ERROR' => env('APP_URL'). ':8000/login/account/signin',
    'CALLBACK_LOGOUT' => env('APP_URL'). ':8000/login/account/signin',
];